...
namespace travel.Models
{
    public class TravelService
    {
        ...
        public string Nnkd { get; set; } // Ngành nghề kinh doanh //Cái chi ri thuộc tính của travel service thôi anh, ý anh là gì, em search thuộc tính của travel service mà nó ra từ viết tắt vậy luôn chứ em k biết :D mà em thays 1 dãy số, e k biết nó là gì, cũng k biết nó dùng để làm giề trong hệ thống mà cũng đưa vào đc
